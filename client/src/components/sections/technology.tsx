             ...
             <div className="relative w-full max-w-md aspect-square">
               ...
               <div className="relative z-10 grid grid-cols-2 gap-4">
                 <div className="space-y-4 mt-8">
                   <div className="h-40 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-md p-4 flex items-end">
                      <span className="text-xs text-secondary font-mono">Lifting Tech</span>
                   </div>
                   <div className="h-56 bg-[#361D45] rounded-2xl border border-white/10 p-4 flex items-end">
                      <span className="text-xs text-white font-mono">Laser Precision</span>
                   </div>
                 </div>
                 <div className="space-y-4">
                   <div className="h-56 bg-primary/10 rounded-2xl border border-primary/20 p-4 flex items-end">
                      <span className="text-xs text-primary font-mono">Body Contour</span>
                   </div>
                   <div className="h-40 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-md p-4 flex items-end">
                      <span className="text-xs text-secondary font-mono">Smart Analysis</span>
                   </div>
                 </div>
               </div>
             </div>
